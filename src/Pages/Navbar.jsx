      ...
      >
        ...
        >
          ...
          <div className="flex space-x-4 mt-8">
            <a href="https://www.linkedin.com/in/ravish-jain-5840712b4/" target="_blank" rel="noopener noreferrer" className="text-black transition duration-300 flex items-center justify-center">
              {/* LinkedIn */}
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-black transition duration-300 flex items-center justify-center">
              {/* Instagram */}
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-black transition duration-300 flex items-center justify-center">
              {/* Facebook */}
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <a href="https://github.com/ravishjain06" target="_blank" rel="noopener noreferrer" className="text-black transition duration-300 flex items-center justify-center">
              {/* GitHub */}
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <a href="https://leetcode.com/u/ravishjain988/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
              <img
                src="/Leetcode--Streamline-Simple-Icons.svg"
                alt="LeetCode"
                className="w-5 h-5"
                style={{ filter: 'grayscale(100%) brightness(1.7)' }}
              />
            </a>
          </div>
        </div>
